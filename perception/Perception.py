...
# 
# 
# Your environment should be installed ahead of ‘numpy’ and ‘pandas’, and the best way to ensure that you can pass some visit https://archive.ics.uci.edu/ml/, if you can't visit the URL, the use will have a solution, please modify the code according to the actual demand
# 
# 
